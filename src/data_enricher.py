...
class DataEnricher:
    ...
    def add_mobile_money_data(self):
        ...
        self.enriched_data = pd.concat(
            [self.enriched_data, telebirr_data, mpesa_data], ignore_index=True
        )
        ...
        fayda_event = pd.DataFrame(
            {
                ...
                "description": [
                    "National rollout of Fayda digital ID system enabling simplified KYC"
                ],
        ...
        ethswitch_event = pd.DataFrame(
            {
                ...
                "description": [
                    "Launch of national switch enabling interoperability between banks and mobile money operators"
                ],
    ...
    def add_impact_links(self):
        ...
        impact_links = pd.DataFrame(
            {
                ...
                "parent_id": [
                    "Telebirr Launch",
                    "M-Pesa Entry",
                    "Fayda Digital ID National Rollout",
                    "EthSwitch Interoperability Platform Launch",
                    "Interest Rate Cap Removal",
                    "M-Pesa Entry",
                ],
        ...
        # Add to enriched data
        self.enriched_data = pd.concat(
            [self.enriched_data, impact_links], ignore_index=True
        )
    ...
    def add_economic_indicators(self):
        ...
        # Add to enriched data
        self.enriched_data = pd.concat(
            [self.enriched_data, economic_data, inflation_data], ignore_index=True
        )
    ...
    def save_enriched_data(self, output_path="data/processed/enriched_data.csv"):
        ...
        with open(log_path, "w") as f:
            ...
            f.write(
                f"- Total records added: {sum(log['records_added'] for log in self.enrichment_log)}\n"
            )
            ...
            f.write(
                "3. Event impacts are estimated based on comparable country evidence\n"
            )
